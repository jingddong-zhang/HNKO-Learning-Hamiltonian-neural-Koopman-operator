...
class lift_Net(torch.nn.Module):
    def __init__(self, n_input, n_hidden, n_output,k,q):
        ...
        self.k = torch.tensor(120.0, requires_grad=True)
...
while out_iters < 1:
    ...
    i = 0
    max_iters = 19417 # 19626,0.00; 19718, 0.01; 19957,0.02; 19417,0.03
    ...
    while i < max_iters:
        ...
        X1, X2, X3, X4 = lift_y[:160-3], lift_y[1:160-2], lift_y[2:160-1], lift_y[3:160]
    ...
    np.save('./data/hnko_70_40_5_1000_{}'.format(sigma),pred_y)
    Y = pred_y
    plt.subplot(121)
