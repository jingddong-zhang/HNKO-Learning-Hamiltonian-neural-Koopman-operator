...
true_y = np.load('./data/true_15_5_1000_symplectic_r7_a9.npy')
end = timeit.default_timer()
print(true_y.shape,end-start)
# np.save('true_{}_5_1000_symplectic_r7_a10'.format(num),true_y) # atol=1e-10: a10
plt.plot(t[:200],true_y[:200,0])
plt.show()
