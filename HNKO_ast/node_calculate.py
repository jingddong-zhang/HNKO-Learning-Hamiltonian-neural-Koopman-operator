...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        if loss < 0.01:
            break
        if itr%500 == 0:
            torch.save(func.state_dict(), './data/node_{}_itr.pkl'.format(args.dim,itr))
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
    ...
    # func.load_state_dict(torch.load('./data/node_{}.pkl'.format(args.dim)))
    func.load_state_dict(torch.load('./data/node_576_280.pkl'))
    pred_t = t
